<?php
    ...
    $username = "krasma31_1"; // Имя пользователя БД
    $password = "Kras2826600"; // Пароль пользователя. Если у пользователя нету пароля то, оставляем пустое значение ""
    $database = "krasma31_1"; // Имя базы данных, которую создали
    ...
    $address_site = "http://krasma31.beget.tech";
    //echo $address_site
?>